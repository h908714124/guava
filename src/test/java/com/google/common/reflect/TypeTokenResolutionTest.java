...
public class TypeTokenResolutionTest extends TestCase {
        ...
        ParameterizedType parameterizedType() {
            return new ParameterizedType() {
                ...
                public Type[] getActualTypeArguments() {
                    return new Type[]{new TypeCapture<P>() {
                    }.capture()};
                }

                @Override
                public Type getOwnerType() {
                    return new TypeCapture<O>() {
                    }.capture();
                }
    ...
    public void testConstructor_typeArgsResolvedFromAncestorClass() {
        assertEquals(String.class, new StringIntegerFoo() {
        }.getClassA());
        assertEquals(Integer.class, new StringIntegerFoo() {
        }.getClassB());
    }
    ...
    public void testResolveNestedClass() {
        assertEquals(String.class, new Owner.Nested<String>() {
        }.getTypeArgument());
    }

    public void testResolveInnerClass() {
        assertEquals(String.class, new Owner<Integer>().new Inner<String>() {
        }.getTypeArgument());
    }

    public void testResolveOwnerClass() {
        assertEquals(Integer.class, new Owner<Integer>().new Inner<String>() {
        }.getOwnerType());
    }

    private static class Mapping<F, T> {

        final Type f = new TypeToken<F>(getClass()) {
        }.getType();
        final Type t = new TypeToken<T>(getClass()) {
        }.getType();
    ...
    private static final class GenericArray<T> {
        ...
        final Type array = new TypeToken<T[]>(getClass()) {
        }.getType();
    }
    ...
    public void testResolveToGenericArrayType() {
        GenericArrayType arrayType =
                (GenericArrayType) new Holder<List<int[][]>[]>() {
                }.getContentType();
    ...
    public void testWithGenericBoundInTypeVariable() throws Exception {
        TypeVariable<?> typeVariable =
                (TypeVariable<?>) new WithGenericBound<String>() {
                }.getTargetType("withTypeVariable");
    ...
    public void testWithGenericLowerBoundInWildcard() throws Exception {
        WildcardType wildcardType =
                (WildcardType) new WithGenericBound<String>() {
    ...
    public void testInterfaceTypeParameterResolution() throws Exception {
        assertEquals(
                String.class,
                TypeToken.of(new TypeToken<ArrayList<String>>() {
                        }.getType())
