...
public class TypeTokenTest extends TestCase {
    ...
    public void testResolveType_fromWildcard() {
        ParameterizedType withWildcardType =
                (ParameterizedType) new TypeCapture<Comparable<? extends Iterable<String>>>() {
                }.capture();
    ...
    public void testGetGenericSuperclass_noSuperclass() {
        ...
        assertEquals(
                TypeToken.of(Object.class), new TypeToken<List<String>[]>() {
                }.getGenericSuperclass());
    }
    ...
    public <T> void testGetGenericSuperclass_typeVariable_unbounded() {
        ...
        assertEquals(TypeToken.of(Object.class), new TypeToken<T[]>() {
        }.getGenericSuperclass());
    }
    ...
    void testGetGenericSuperclass_typeVariable_boundIsTypeVariableAndClass() {
        assertEquals(
                ...
                TypeToken.of(new TypeCapture<T1>() {
                }.capture()).getGenericSuperclass());
        assertEquals(TypeToken.of(Object.class), new TypeToken<T[]>() {
        }.getGenericSuperclass());
    }
    ...
    void testGetGenericSuperclass_typeVariable_boundIsTypeVariableAndInterface() {
        ...
        assertEquals(TypeToken.of(Object.class), new TypeToken<T1[]>() {
        }.getGenericSuperclass());
    }
    ...
    public <T> void testGetGenericInterfaces_typeVariable_unbounded() {
        assertThat(TypeToken.of(new TypeCapture<T>() {
    ...
    void testGetGenericInterfaces_typeVariable_boundsAreClassWithInterface() {
        makeUnmodifiable(TypeToken.of(new TypeCapture<T>() {
        }.capture()).getGenericInterfaces())
    ...
    void testGetGenericInterfaces_typeVariable_boundIsTypeVariableAndClass() {
        assertThat(TypeToken.of(new TypeCapture<T2>() {
        }.capture()).getGenericInterfaces()).isEmpty();
    ...
    void testGetGenericInterfaces_typeVariable_boundIsTypeVariableAndInterface() {
        makeUnmodifiable(TypeToken.of(new TypeCapture<T2>() {
        }.capture()).getGenericInterfaces())
                .containsExactly(TypeToken.of(new TypeCapture<T1>() {
                }.capture()));
        assertHasArrayInterfaces(new TypeToken<T2[]>() {
        });
    }
    ...
    public void testGetGenericInterfaces_withInterfaces() {
        ...
        for (TypeToken<?> interfaceType :
                new TypeToken<Implementation<Integer, String>>() {
                }.getGenericInterfaces()) {
            interfaceMap.put(interfaceType.getRawType(), interfaceType.getType());
        }
        assertEquals(
                ImmutableMap.of(
                        Iterable.class, new TypeToken<Iterable<String>>() {
                        }.getType(),
                        Map.class, new TypeToken<Map<Integer, String>>() {
                        }.getType()),
                interfaceMap);
    }
    ...
    public <T> void testAssignableParameterizedTypeToObject() {
        assertTrue(
                TypeToken.of(Object.class).isSupertypeOf(TypeToken.of(new TypeCapture<T>() {
                }.capture())));
        assertFalse(
                TypeToken.of(int.class).isSupertypeOf(TypeToken.of(new TypeCapture<T>() {
                }.capture())));
    }

    public <T, T1 extends T> void testAssignableGenericArrayToGenericArray() {
        assertTrue(new TypeToken<T[]>() {
        }.isSupertypeOf(new TypeToken<T[]>() {
        }));
        assertTrue(new TypeToken<T[]>() {
        }.isSupertypeOf(new TypeToken<T1[]>() {
        }));
        assertFalse(new TypeToken<T[]>() {
        }.isSupertypeOf(new TypeToken<T[][]>() {
        }));
    }
    ...
    void testisSupertypeOf_typeVariable() {
        assertAssignable(
                TypeToken.of(new TypeCapture<N1>() {
                }.capture()),
                TypeToken.of(new TypeCapture<N1>() {
                }.capture()));
        ...
        assertAssignable(
                TypeToken.of(new TypeCapture<N11>() {
                }.capture()),
                TypeToken.of(new TypeCapture<N1>() {
                }.capture()));
        assertNotAssignable(
                TypeToken.of(new TypeCapture<N2>() {
                }.capture()),
                TypeToken.of(new TypeCapture<N1>() {
                }.capture()));
    }
    ...
    void testisSupertypeOf_wildcardType_lowerBoundMatch() {
        ...
        assertNotAssignable(
                new TypeToken<ArrayList<? super N11>>() {
                }, new TypeToken<List<? super Number>>() {
                });
        assertAssignable(
                new TypeToken<ArrayList<? super N1>>() {
                }, new TypeToken<List<? super N11>>() {
                });
        assertAssignable(
                new TypeToken<ArrayList<? super Number>>() {
                }, new TypeToken<List<? super N11>>() {
                });

        // ? super Number
        assertNotAssignable(
                new TypeToken<ArrayList<N11>>() {
                }, new TypeToken<List<? super Number>>() {
                });
        assertAssignable(
                new TypeToken<ArrayList<Number>>() {
                }, new TypeToken<List<? super Number>>() {
                });
        assertAssignable(
    ...
    void testisSupertypeOf_recursiveTypeVariableBounds() {
        assertAssignable(
                TypeToken.of(new TypeCapture<L>() {
                }.capture()),
                TypeToken.of(new TypeCapture<L>() {
                }.capture()));
        assertNotAssignable(
                TypeToken.of(new TypeCapture<R>() {
                }.capture()),
                TypeToken.of(new TypeCapture<L>() {
                }.capture()));
    ...
    public <From extends String & List<? extends String>> void testMultipleTypeBoundsAssignability() {
        assertTrue(new Assignability<From, String>() {
        }.isAssignable());
        assertFalse(new Assignability<From, Number>() {
        }.isAssignable());
        assertTrue(new Assignability<From, Iterable<? extends CharSequence>>() {
        }.isAssignable());
        assertFalse(new Assignability<From, Iterable<Object>>() {
        }.isAssignable());
    }
    ...
    private static <N1 extends Number, N11 extends N1> void assignabilityTestWithTypeVariables() {
        ...
        assertTrue(new Assignability<N11, Number>() {
        }.isAssignable());
        assertFalse(new Assignability<Number, N11>() {
        }.isAssignable());
    }
    ...
    public <T> void testIsArray_genericArrayClasses() {
        assertFalse(TypeToken.of(new TypeCapture<T>() {
        }.capture()).isArray());
        assertTrue(new TypeToken<T[]>() {
        }.isArray());
        assertTrue(new TypeToken<T[][]>() {
    ...
    void testGetSupertype_typeVariableWithMultipleBounds() {
        assertEquals(
                Number.class, new TypeToken<T>(getClass()) {
    ...
    public void testGetSupertype_fromWildcard() {
        ...
        TypeToken<? extends List<String>> type =
                (TypeToken<? extends List<String>>)
                        TypeToken.of(Types.subtypeOf(new TypeToken<List<String>>() {
                        }.getType()));
        assertEquals(new TypeToken<Iterable<String>>() {
        }, type.getSupertype(Iterable.class));
    }
    ...
    public <T extends Iterable<String>> void testGetSupertype_fromTypeVariable() {
        ...
        TypeToken<T> typeVariableToken = (TypeToken<T>) TypeToken.of(new TypeCapture<T>() {
        }.capture());
        assertEquals(
                new TypeToken<Iterable<String>>() {
    ...
    public void testGetSupertype_notSupertype() {
        try {
            new TypeToken<List<String>>() {
            }.getSupertype((Class) String.class);
            fail();
    ...
    public void testGetSupertype_fullySpecializedType() {
        Type expectedType = new TypeToken<Map<String, List<Object>>>() {
        }.getType();
        assertEquals(
                expectedType,
                new TypeToken<ListMap<String, Object>>() {
    ...
    public <V> void testGetSupertype_partiallySpecializedType() {
        Type expectedType = new TypeToken<Map<String, List<V>>>() {
        }.getType();
        assertEquals(
                expectedType, new TypeToken<StringListMap<V>>() {
                }.getSupertype(Map.class).getType());
    }
    ...
    public void testGetSubtype_fromWildcard() {
        ...
        TypeToken<? super Iterable<String>> type =
                (TypeToken<? super Iterable<String>>)
                        TypeToken.of(Types.supertypeOf(new TypeToken<Iterable<String>>() {
                        }.getType()));
        assertEquals(new TypeToken<List<String>>() {
    ...
    public void testGetSubtype_fromWildcard_lowerBoundNotSupertype() {
        ...
        TypeToken<? super Iterable<String>> type =
                (TypeToken<? super Iterable<String>>)
                        TypeToken.of(Types.supertypeOf(new TypeToken<ImmutableList<String>>() {
                        }.getType()));
        try {
            type.getSubtype(List.class);
            fail();
    ...
    public void testGetSubtype_fromWildcard_upperBounded() {
        ...
        TypeToken<? extends Iterable<String>> type =
                (TypeToken<? extends Iterable<String>>)
                        TypeToken.of(Types.subtypeOf(new TypeToken<Iterable<String>>() {
                        }.getType()));
        try {
    ...
    public void testGetSubtype_fromRawClass() {
        assertEquals(List.class, new TypeToken<Iterable>() {
    ...
    public void testGetSubtype_recursiveTypeBoundInSubtypeTranslatedAsIs() {
        ...
        ParameterizedType subtype =
                (ParameterizedType)
                        new TypeToken<BaseWithTypeVar<List<?>>>() {
    ...
    public <T> void testWhere_circleRejected() {
        ...
        try {
            type.where(
                    ...
                    (TypeToken<T>) TypeToken.of(new TypeCapture<T>() {
                    }.capture()));
            fail();
        } catch (IllegalArgumentException expected) {
        }
    ...
    public void testWildcardCaptured_wildcardWithImplicitBound() throws Exception {
        ...
        assertThat(new TypeToken<List<?>>() {
        }.isSupertypeOf(parameterType)).isTrue();
    }
    ...
    public void testWildcardCaptured_wildcardWithExplicitBound() throws Exception {
        ...
        assertThat(new TypeToken<List<? extends Number>>() {
        }.isSupertypeOf(parameterType)).isTrue();
    }
    ...
    public void testWildcardCaptured_typeVariableDeclaresTypeBound_wildcardHasNoExplicitUpperBound()
        ...
        assertThat(captured.getBounds()).asList().containsExactly(Number.class);
        assertThat(new TypeToken<List<? extends Number>>() {
        }.isSupertypeOf(fieldType)).isTrue();
        assertThat(new TypeToken<List<? extends Iterable<?>>>() {
        }.isSupertypeOf(fieldType)).isFalse();
    }
    ...
    public void testWildcardCaptured_typeVariableDeclaresTypeBound_wildcardAddsNewUpperBound()
        ...
        assertThat(captured.getBounds())
                .asList()
                .containsNoneOf(Object.class, new TypeToken<Iterable<Number>>() {
                }.getType());
        assertThat(new TypeToken<List<? extends Number>>() {
        }.isSupertypeOf(fieldType)).isTrue();
        assertThat(new TypeToken<List<? extends Iterable<?>>>() {
        }.isSupertypeOf(fieldType)).isTrue();
        assertThat(new TypeToken<List<? extends Iterable<Number>>>() {
        }.isSupertypeOf(fieldType))
                .isFalse();
    }
    ...
    public void testArrayClassPreserved() {
        ...
        assertEquals(Integer.class, new TypeToken<Integer>() {
        }.getType());
    ...
    public void testMethod_equals() throws NoSuchMethodException {
        ...
        new EqualsTester()
                ...
                .addEqualityGroup(new TypeToken<List<Integer>>() {
                }.method(getMethod))
                .addEqualityGroup(new TypeToken<List<String>>() {
                }.method(getMethod))
                .addEqualityGroup(new TypeToken<List<Integer>>() {
                }.method(setMethod))
                .addEqualityGroup(new TypeToken<List<String>>() {
    ...
    public void testConstructor_equals() throws NoSuchMethodException {
        ...
        new EqualsTester()
                ...
                .addEqualityGroup(new TypeToken<ArrayList<Integer>>() {
                }.constructor(defaultConstructor))
                .addEqualityGroup(new TypeToken<ArrayList<String>>() {
                }.constructor(defaultConstructor))
                .addEqualityGroup(new TypeToken<ArrayList<Integer>>() {
    ...
    public void testRejectTypeVariable_parameterizedType() {
        assertNoTypeVariable(new TypeCapture<Iterable<String>>() {
        }.capture());
    }

    public void testRejectTypeVariable_wildcardType() {
        assertNoTypeVariable(new TypeCapture<Iterable<? extends String>>() {
        }.capture());
        assertNoTypeVariable(new TypeCapture<Iterable<? super String>>() {
        }.capture());
    }
    ...
    public <T> void testRejectTypeVariable_withTypeVariable() {
        assertHasTypeVariable(new TypeCapture<T>() {
        }.capture());
        assertHasTypeVariable(new TypeCapture<T[]>() {
        }.capture());
        assertHasTypeVariable(new TypeCapture<Iterable<T>>() {
        }.capture());
        assertHasTypeVariable(new TypeCapture<Map<String, T>>() {
        }.capture());
        assertHasTypeVariable(new TypeCapture<Map<String, ? extends T>>() {
        }.capture());
        assertHasTypeVariable(new TypeCapture<Map<String, ? super T[]>>() {
        }.capture());
    }
    ...
    public void testTypeResolution() {
        assertEquals(String.class, new IKnowMyType<String>() {
        }.type().getType());
        assertEquals(
                new TypeToken<Map<String, Integer>>() {
                },
                new IKnowMyType<Map<String, Integer>>() {
                }.type());
    }
    ...
    private static class ITryToSerializeMyTypeVariable<T> {
        void go() {
            SerializableTester.reserialize(TypeToken.of(new TypeCapture<T>() {
            }.capture()));
        }
    }
    ...
    private static <T, X> TypeToken<T> substitute(TypeToken<T> type, Class<X> arg) {
        return type.where(new TypeParameter<X>() {
        }, arg);
    }
    ...
    public <A, B> void testEquals() {
        new EqualsTester()
                ...
                .addEqualityGroup(
                        TypeToken.of(new TypeCapture<A>() {
                        }.capture()),
                        TypeToken.of(new TypeCapture<A>() {
                        }.capture()))
                .addEqualityGroup(TypeToken.of(new TypeCapture<B>() {
                }.capture()))
                .testEquals();
    }
    ...
    private static class Assignability<From, To> {
        ...
        boolean isAssignable() {
            return new TypeToken<To>(getClass()) {
            }.isSupertypeOf(new TypeToken<From>(getClass()) {
            });
        }
