...
public final class ObjectArrays {
     ...
     */
    static @Nullable
    Object[] toArrayImpl(Collection<?> c) {
     ...
     */
    static @Nullable
    Object[] copyAsObjectArray(@Nullable Object[] elements, int offset, int length) {
    ...
    Object[] fillArray(Iterable<?> elements, @Nullable Object[] array) {
        int i = 0;
