...
final class Synchronized {
    ...
    static <K, V> BiMap<K, V> biMap(
            BiMap<K, V> bimap, Object mutex) {
    ...
    Map.Entry<K, V> nullableSynchronizedEntry(
            Map.Entry<K, V> entry, Object mutex) {
        if (entry == null) {
            return null;
        }
    ...
    static <R, C, V>
    Table<R, C, V> table(Table<R, C, V> table, Object mutex) {
